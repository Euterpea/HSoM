...
/* package Euterpea-2.0.0 */
#define VERSION_Euterpea "2.0.0"
...
/* package UISF-0.4.0.0 */
#define VERSION_UISF "0.4.0.0"
#define MIN_VERSION_UISF(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
...
/* package markov-chain-0.0.3.3 */
#define VERSION_markov_chain "0.0.3.3"
...
#define CURRENT_PACKAGE_KEY "HSoM_56c7Fc3XZJk0d4DpEaxcwM"
